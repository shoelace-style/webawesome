(() => {
  ...
  var $t = typeof window < 'u' ? window : typeof globalThis < 'u' ? globalThis : global,
    fe = class {
      constructor(e) {
        (this.options = e), (this._listeners = 'WeakMap' in $t ? new WeakMap() : void 0);
      }
      observe(e, t) {
        return (
      ...
      _getObserver() {
        ...
        return (e = this._observer) !== null && e !== void 0
          ...
          : (this._observer = new ResizeObserver(t => {
              var s;
              for (let r of t)
                fe.entries.set(r.target, r), (s = this._listeners.get(r.target)) === null || s === void 0 || s(r);
            }));
      }
    };
  ...
  var Xe = class {
    ...
    m(e, t, s = null) {
      this.e ||
        (this.is_svg ? (this.e = us(t.nodeName)) : (this.e = k(t.nodeType === 11 ? 'TEMPLATE' : t.nodeName)),
  ...
  function hs(n) {
    let e = [],
      t = [];
    se.forEach(s => (n.indexOf(s) === -1 ? e.push(s) : t.push(s))), t.forEach(s => s()), (se = e);
  }
  var Je = new Set(),
    ee;
  function ie() {
    ...
    r && r.m(e, t),
      s ||
        rt(() => {
          ...
          n.$$.on_destroy ? n.$$.on_destroy.push(...i) : V(i), (n.$$.on_mount = []);
        }),
      l.forEach(rt);
  }
  function oe(n, e) {
  ...
  function ps(n, e) {
    n.$$.dirty[0] === -1 && (ne.push(n), fs(), n.$$.dirty.fill(0)), (n.$$.dirty[(e / 31) | 0] |= 1 << e % 31);
  }
    ...
    if (
      ((h.ctx = t
        ? t(n, e.props || {}, (f, c, ...E) => {
            ...
            return (
              h.ctx && r(h.ctx[f], (h.ctx[f] = u)) && (!h.skip_bound && h.bound[f] && h.bound[f](u), _ && ps(n, f)), c
            );
          })
        : []),
      h.update(),
      ...
      e.intro && z(n.$$.fragment), he(n, e.target, e.anchor, e.customElement), os(), sn();
    }
    _e(o);
  }
  var gs;
  typeof HTMLElement == 'function' &&
    (gs = class extends HTMLElement {
      ...
      $set(n) {
        this.$$set && !xt(n) && ((this.$$.skip_bound = !0), this.$$set(n), (this.$$.skip_bound = !1));
      }
    });
  var q = class {
    $destroy() {
    ...
    if (l > 1 && l < 9) {
      if (((t.language = s.slice(0, l)), l < 4)) {
        ...
        for (
          ...
          if (a > 2) return i(l, 3, 'Too many extended language subtags, expected at most 3 subtags');
      ...
      for (
        r.charCodeAt(l) === 45 &&
          ...
          r.charCodeAt(l) === 45 &&
            (D(r.charCodeAt(l + 1)) && D(r.charCodeAt(l + 2)) && !D(r.charCodeAt(l + 3))
        ...
        if (o - a > 4 || (o - a > 3 && $(r.charCodeAt(a)))) t.variants.push(s.slice(a, o)), (l = o);
        else break;
      }
      for (
        ;
        ...
        let a = l + 2,
          o = 0;
        for (; r.charCodeAt(a) === 45 && Y(r.charCodeAt(a + 1)) && Y(r.charCodeAt(a + 2)); ) {
          let h = a + 1;
        ...
        t.extensions.push({ singleton: s.charAt(l + 1), extensions: s.slice(l + 3, a).split('-') }), (l = a);
      }
    } else l = 0;
    if ((l === 0 && r.charCodeAt(l) === 120) || (r.charCodeAt(l) === 45 && r.charCodeAt(l + 1) === 120)) {
      l = l ? l + 2 : 1;
      let a = l;
    ...
    return {
      c() {
        i && i.c(),
          ...
          p(s, 'class', 'pagefind-ui__result-title pagefind-ui__loading svelte-j9e30'),
          p(l, 'class', 'pagefind-ui__result-excerpt pagefind-ui__loading svelte-j9e30'),
      ...
      p(a, o) {
        a[0] ? i || ((i = _n(a)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
      },
      d(a) {
        i && i.d(a), a && C(e), a && C(t);
      }
  ...
  function Rs(n) {
    ...
    return {
      ...
      p(u, m) {
        u[0] ? (c ? c.p(u, m) : ((c = fn(u)), c.c(), c.m(e.parentNode, e))) : c && (c.d(1), (c = null)),
          m & 2 && l !== (l = u[1].meta?.title + '') && N(i, l),
          m & 2 && a !== (a = u[1].meta?.url || u[1].url) && p(r, 'href', a),
          m & 2 && _ !== (_ = u[1].excerpt + '') && (h.innerHTML = _),
          u[2].length ? (E ? E.p(u, m) : ((E = hn(u)), E.c(), E.m(t, null))) : E && (E.d(1), (E = null));
      },
      d(u) {
  ...
  function _n(n) {
    ...
    return {
      c() {
        (e = k('div')), p(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-j9e30');
      },
      m(t, s) {
        y(t, e, s);
      },
  ...
  function fn(n) {
    ...
    return {
      c() {
        (e = k('div')), t && t.c(), p(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30');
      },
      m(s, r) {
        y(s, e, r), t && t.m(e, null);
      },
      p(s, r) {
        s[1].meta.image ? (t ? t.p(s, r) : ((t = dn(s)), t.c(), t.m(e, null))) : t && (t.d(1), (t = null));
      },
      d(s) {
        s && C(e), t && t.d();
      }
    ...
    return {
      ...
      p(r, l) {
        l & 2 && !le(e.src, (t = r[1].meta?.image)) && p(e, 'src', t),
          l & 2 && s !== (s = r[1].meta?.image_alt || r[1].meta?.title) && p(e, 'alt', s);
      },
      d(r) {
        r && C(e);
      }
  ...
  function mn(n) {
    ...
    return {
      ...
      p(o, h) {
        h & 4 && t !== (t = o[8].replace(/^(\w)/, pn) + '') && N(s, t), h & 4 && l !== (l = o[9] + '') && N(i, l);
      },
      d(o) {
        o && C(e);
      }
  ...
  function Ts(n) {
    ...
    return {
      ...
      p(l, [i]) {
        s === (s = t(l, i)) && r ? r.p(l, i) : (r.d(1), (r = s(l)), r && (r.c(), r.m(e, null)));
      },
      i: j,
      o: j,
      d(l) {
  ...
  var ct = class extends q {
      constructor(e) {
        super(), J(this, e, ks, Ts, G, { show_images: 0, process_result: 4, result: 5 });
      }
    },
    gn = ct;
  function En(n, e, t) {
    ...
    return {
      c() {
        i && i.c(),
          ...
          p(s, 'class', 'pagefind-ui__result-title pagefind-ui__loading svelte-4xnkmf'),
          p(l, 'class', 'pagefind-ui__result-excerpt pagefind-ui__loading svelte-4xnkmf'),
      ...
      p(a, o) {
        a[0] ? i || ((i = Rn(a)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
      },
      d(a) {
        i && i.d(a), a && C(e), a && C(t);
      }
  ...
  function ys(n) {
    ...
    return {
      c() {
        f && f.c(), (e = M()), (t = k('div')), (s = k('p')), (r = k('a')), (i = A(l)), (o = M()), c && c.c(), (h = M());
      ...
      m(d, R) {
        f && f.m(d, R), y(d, e, R), y(d, t, R), b(t, s), b(s, r), b(r, i), b(t, o), c && c.m(t, null), b(t, h);
        for (let T = 0; T < u.length; T += 1) u[T] && u[T].m(t, null);
        b(t, _), m && m.m(t, null);
      },
      p(d, R) {
        if (
          (d[0] ? (f ? f.p(d, R) : ((f = Tn(d)), f.c(), f.m(e.parentNode, e))) : f && (f.d(1), (f = null)),
          R & 2 && l !== (l = d[1].meta?.title + '') && N(i, l),
          R & 2 && a !== (a = d[1].meta?.url || d[1].url) && p(r, 'href', a),
          d[4] ? (c ? c.p(d, R) : ((c = Cn(d)), c.c(), c.m(t, h))) : c && (c.d(1), (c = null)),
          R & 8)
        ) {
          E = d[3];
          let T;
        ...
        d[2].length ? (m ? m.p(d, R) : ((m = Sn(d)), m.c(), m.m(t, null))) : m && (m.d(1), (m = null));
      },
      d(d) {
  ...
  function Rn(n) {
    ...
    return {
      c() {
        (e = k('div')), p(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-4xnkmf');
      },
      m(t, s) {
        y(t, e, s);
      },
  ...
  function Tn(n) {
    ...
    return {
      c() {
        (e = k('div')), t && t.c(), p(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf');
      },
      m(s, r) {
        y(s, e, r), t && t.m(e, null);
      },
      p(s, r) {
        s[1].meta.image ? (t ? t.p(s, r) : ((t = kn(s)), t.c(), t.m(e, null))) : t && (t.d(1), (t = null));
      },
      d(s) {
        s && C(e), t && t.d();
      }
  ...
  function Cn(n) {
    ...
    return {
      c() {
        (e = k('p')), p(e, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf');
      },
      m(s, r) {
  ...
  function yn(n) {
    ...
    return {
      ...
      m(_, f) {
        y(_, e, f), b(e, t), b(t, s), b(s, l), b(e, a), b(e, o), (o.innerHTML = h);
      },
      p(_, f) {
  ...
  function vn(n) {
    ...
    return {
      ...
      p(o, h) {
        h & 4 && t !== (t = o[11].replace(/^(\w)/, Mn) + '') && N(s, t), h & 4 && l !== (l = o[12] + '') && N(i, l);
      },
      d(o) {
        o && C(e);
      }
  ...
  function Ss(n) {
    ...
    return {
      c() {
        (e = k('li')), r.c(), p(e, 'class', 'pagefind-ui__result svelte-4xnkmf');
      },
      m(l, i) {
        y(l, e, i), r.m(e, null);
      },
      ...
      c = async u => {
        t(1, (a = await u.data())),
          ...
          Array.isArray(a.sub_results) &&
            ...
            _ ? t(3, (h = f(a.sub_results.slice(1), 3))) : t(3, (h = f([...a.sub_results], 3))));
      },
  ...
  var _t = class extends q {
      constructor(e) {
        super(), J(this, e, vs, Ss, G, { show_images: 0, process_result: 6, result: 7 });
      }
    },
    An = _t;
  function wn(n, e, t) {
  ...
  function Hn(n) {
    ...
    return {
      ...
      p(o, h) {
        if ((h & 56 && s !== (s = o[3]('filters_label', o[4], o[5]) + '') && N(r, s), h & 71)) {
    ...
    return {
      ...
      p(S, w) {
        (n = S),
          ...
          w & 2 && l !== (l = n[13]) && ((t.__value = l), (t.value = t.__value)),
          w & 3 && (t.checked = n[0][`${n[9]}:${n[13]}`]),
          w & 2 && h !== (h = n[13] + '') && o.p(h),
          w & 2 && f !== (f = n[14] + '') && N(c, f),
          w & 2 && u !== (u = n[9] + '-' + n[13]) && p(a, 'for', u),
          w & 3 && W(e, 'pagefind-ui__filter-value--checked', n[0][`${n[9]}:${n[13]}`]);
      },
      d(S) {
        S && C(e), (d = !1), R();
      }
  ...
  function jn(n) {
    ...
    return {
      c() {
        (e = k('details')), (t = k('summary')), (r = M()), (l = k('fieldset')), (i = k('legend')), (o = M());
      ...
      m(c, E) {
        y(c, e, E), b(e, t), (t.innerHTML = s), b(e, r), b(e, l), b(l, i), (i.innerHTML = a), b(l, o);
        for (let u = 0; u < f.length; u += 1) f[u] && f[u].m(l, null);
        b(e, h);
      },
      p(c, E) {
        if (
          (E & 2 && s !== (s = c[9].replace(/^(\w)/, zn) + '') && (t.innerHTML = s),
    ...
    return {
      ...
      p(r, [l]) {
        l & 2 && (e = r[1] && Object.entries(r[1]).length),
          e ? (s ? s.p(r, l) : ((s = Hn(r)), s.c(), s.m(t.parentNode, t))) : s && (s.d(1), (s = null));
      },
      i: j,
      o: j,
      d(r) {
  ...
  var ft = class extends q {
    ...
    Dn = ft;
  var dt = {};
  v(dt, { comments: () => Fs, default: () => Os, direction: () => Hs, strings: () => Ns, thanks_to: () => ws });
  ...
  var ht = {};
  v(ht, { comments: () => zs, default: () => Is, direction: () => Ds, strings: () => Us, thanks_to: () => js });
  ...
  var mt = {};
  v(mt, { comments: () => Ls, default: () => Ws, direction: () => qs, strings: () => Bs, thanks_to: () => Ps });
  ...
  var pt = {};
  v(pt, { comments: () => Gs, default: () => Ys, direction: () => Ks, strings: () => Js, thanks_to: () => Vs });
  ...
  var gt = {};
  v(gt, { comments: () => Zs, default: () => $s, direction: () => Qs, strings: () => xs, thanks_to: () => Xs });
  ...
  var Et = {};
  v(Et, { comments: () => tr, default: () => rr, direction: () => nr, strings: () => sr, thanks_to: () => er });
  ...
  var bt = {};
  v(bt, { comments: () => ir, default: () => ur, direction: () => ar, strings: () => or, thanks_to: () => lr });
  ...
  var Rt = {};
  v(Rt, { comments: () => _r, default: () => hr, direction: () => fr, strings: () => dr, thanks_to: () => cr });
  ...
  var Tt = {};
  v(Tt, { comments: () => pr, default: () => br, direction: () => gr, strings: () => Er, thanks_to: () => mr });
  ...
  var kt = {};
  v(kt, { comments: () => Tr, default: () => yr, direction: () => kr, strings: () => Cr, thanks_to: () => Rr });
  ...
  var Ct = {};
  v(Ct, { comments: () => vr, default: () => wr, direction: () => Mr, strings: () => Ar, thanks_to: () => Sr });
  ...
  var yt = {};
  v(yt, { comments: () => Hr, default: () => jr, direction: () => Nr, strings: () => Or, thanks_to: () => Fr });
  ...
  var St = {};
  v(St, { comments: () => Dr, default: () => Pr, direction: () => Ur, strings: () => Ir, thanks_to: () => zr });
  ...
  var vt = {};
  v(vt, { comments: () => qr, default: () => Vr, direction: () => Br, strings: () => Wr, thanks_to: () => Lr });
  var Lr = 'Nixentric',
    qr = '',
    Br = 'ltr',
    Wr = {
  ...
  var Mt = {};
  v(Mt, { comments: () => Kr, default: () => Xr, direction: () => Jr, strings: () => Yr, thanks_to: () => Gr });
  ...
  var At = {};
  v(At, { comments: () => Qr, default: () => el, direction: () => xr, strings: () => $r, thanks_to: () => Zr });
  var Zr = 'Tate',
    Qr = '',
    xr = 'ltr',
    $r = {
  ...
  var wt = {};
  v(wt, { comments: () => nl, default: () => ll, direction: () => sl, strings: () => rl, thanks_to: () => tl });
  var tl = '',
    nl = '',
    sl = 'ltr',
    rl = {
  ...
  var Ft = {};
  v(Ft, { comments: () => al, default: () => cl, direction: () => ol, strings: () => ul, thanks_to: () => il });
  ...
  var Ht = {};
  v(Ht, { comments: () => fl, default: () => ml, direction: () => dl, strings: () => hl, thanks_to: () => _l });
  ...
  var Nt = {};
  v(Nt, { comments: () => gl, default: () => Rl, direction: () => El, strings: () => bl, thanks_to: () => pl });
  var pl = '',
    gl = '',
    El = 'ltr',
    bl = {
  ...
  var Ot = {};
  v(Ot, { comments: () => kl, default: () => Sl, direction: () => Cl, strings: () => yl, thanks_to: () => Tl });
  var Tl = 'Jonatah',
    kl = '',
    Cl = 'ltr',
    yl = {
  ...
  var jt = {};
  v(jt, { comments: () => Ml, default: () => Fl, direction: () => Al, strings: () => wl, thanks_to: () => vl });
  ...
  var zt = {};
  v(zt, { comments: () => Nl, default: () => zl, direction: () => Ol, strings: () => jl, thanks_to: () => Hl });
  ...
  var Dt = {};
  v(Dt, { comments: () => Ul, default: () => Ll, direction: () => Il, strings: () => Pl, thanks_to: () => Dl });
  ...
  var Ut = {};
  v(Ut, { comments: () => Bl, default: () => Gl, direction: () => Wl, strings: () => Vl, thanks_to: () => ql });
  var ql = '',
    Bl = '',
    Wl = 'ltr',
    Vl = {
  ...
  var It = {};
  v(It, { comments: () => Jl, default: () => Zl, direction: () => Yl, strings: () => Xl, thanks_to: () => Kl });
  ...
  var Pt = {};
  v(Pt, { comments: () => xl, default: () => ti, direction: () => $l, strings: () => ei, thanks_to: () => Ql });
  ...
  var Lt = {};
  v(Lt, { comments: () => si, default: () => ii, direction: () => ri, strings: () => li, thanks_to: () => ni });
  var ni = 'Amber Song',
    si = '',
    ri = 'ltr',
    li = {
  ...
  var qt = {};
  v(qt, { comments: () => oi, default: () => _i, direction: () => ui, strings: () => ci, thanks_to: () => ai });
  var ai = 'Amber Song',
    oi = '',
    ui = 'ltr',
    ci = {
  ...
  var Bt = {};
  v(Bt, { comments: () => di, default: () => pi, direction: () => hi, strings: () => mi, thanks_to: () => fi });
  var fi = 'Amber Song',
    di = '',
    hi = 'ltr',
    mi = {
      ...
      re.push(() => an(e, 'selected_filters', r)),
      {
        ...
        p(i, a) {
          ...
          a[0] & 16 && (o.show_empty_filters = i[4]),
            ...
            !t && a[0] & 128 && ((t = !0), (o.selected_filters = i[7]), nn(() => (t = !1))),
            e.$set(o);
        },
        i(i) {
  ...
  function qn(n) {
    ...
    return (
      ...
      {
        c() {
          (e = k('div')), s.c(), p(e, 'class', 'pagefind-ui__results-area svelte-e9gkc3');
        },
        m(o, h) {
  ...
  function bi(n) {
    let e,
      ...
      o;
    function h(m, d) {
      return m[11].results.length === 0 ? Ci : m[11].results.length === 1 ? ki : Ti;
    }
    let _ = h(n, [-1, -1]),
      f = _(n),
    ...
    return {
      ...
      p(m, d) {
        _ === (_ = h(m, d)) && f ? f.p(m, d) : (f.d(1), (f = _(m)), f && (f.c(), f.m(e, null))),
          d[0] & 34830 &&
            ((c = m[11].results.slice(0, m[15])), ie(), (r = ln(r, d, E, 1, m, c, l, s, rn, Bn, null, Pn)), ae()),
  ...
  function Ri(n) {
    ...
    return {
      ...
      p(s, r) {
        s[14] ? (t ? t.p(s, r) : ((t = Vn(s)), t.c(), t.m(e.parentNode, e))) : t && (t.d(1), (t = null));
      },
      i: j,
      o: j,
      d(s) {
  ...
  function Ti(n) {
    let e =
        n[18]('many_results', n[17], n[5])
          ...
          .replace(/\[COUNT\]/, new Intl.NumberFormat(n[5].language).format(n[11].results.length)) + '',
      t;
    return {
      c() {
        t = A(e);
          ...
          e !==
            (e =
              s[18]('many_results', s[17], s[5])
                ...
                .replace(/\[COUNT\]/, new Intl.NumberFormat(s[5].language).format(s[11].results.length)) + '') &&
          N(t, e);
      },
      d(s) {
        s && C(t);
  ...
  function ki(n) {
    let e =
        n[18]('one_result', n[17], n[5])
          .replace(/\[SEARCH_TERM\]/, n[14])
          .replace(/\[COUNT\]/, new Intl.NumberFormat(n[5].language).format(1)) + '',
      t;
    return {
      c() {
        t = A(e);
          ...
          e !==
            (e =
              s[18]('one_result', s[17], s[5])
                .replace(/\[SEARCH_TERM\]/, s[14])
                .replace(/\[COUNT\]/, new Intl.NumberFormat(s[5].language).format(1)) + '') &&
          N(t, e);
      },
      d(s) {
        s && C(t);
  ...
  function Ci(n) {
    let e = n[18]('zero_results', n[17], n[5]).replace(/\[SEARCH_TERM\]/, n[14]) + '',
      t;
    return {
      c() {
        t = A(e);
      ...
      p(s, r) {
        r[0] & 147488 &&
          e !== (e = s[18]('zero_results', s[17], s[5]).replace(/\[SEARCH_TERM\]/, s[14]) + '') &&
          N(t, e);
      },
      d(s) {
        s && C(t);
  ...
  function yi(n) {
    let e, t;
    return (
      (e = new gn({ props: { show_images: n[1], process_result: n[3], result: n[48] } })),
      {
        c() {
          Ze(e.$$.fragment);
        },
  ...
  function Si(n) {
    let e, t;
    return (
      (e = new An({ props: { show_images: n[1], process_result: n[3], result: n[48] } })),
      {
        c() {
          Ze(e.$$.fragment);
        },
  ...
  function Wn(n) {
    ...
    return {
      c() {
        (e = k('button')), (s = A(t)), p(e, 'type', 'button'), p(e, 'class', 'pagefind-ui__button svelte-e9gkc3');
      },
      m(i, a) {
        y(i, e, a), b(e, s), r || ((l = K(e, 'click', n[20])), (r = !0));
      },
      p(i, a) {
        a[0] & 131104 && t !== (t = i[18]('load_more', i[17], i[5]) + '') && N(s, t);
      },
      d(i) {
        i && C(e), (r = !1), l();
      }
  ...
  function Vn(n) {
    let e,
      t = n[18]('searching', n[17], n[5]).replace(/\[SEARCH_TERM\]/, n[14]) + '',
      s;
    return {
      c() {
        (e = k('p')), (s = A(t)), p(e, 'class', 'pagefind-ui__message svelte-e9gkc3');
      },
      m(r, l) {
        y(r, e, l), b(e, s);
      },
      p(r, l) {
        l[0] & 147488 && t !== (t = r[18]('searching', r[17], r[5]).replace(/\[SEARCH_TERM\]/, r[14]) + '') && N(s, t);
      },
      d(r) {
        r && C(e);
      }
  ...
  function vi(n) {
    ...
    return {
      ...
      p(T, S) {
        (!E || (S[0] & 131104 && r !== (r = T[18]('placeholder', T[17], T[5])))) && p(s, 'placeholder', r),
          S[0] & 64 && s.value !== T[6] && it(s, T[6]),
          (!E || S[0] & 131104) && a !== (a = T[18]('clear_search', T[17], T[5]) + '') && N(o, a),
          ...
          (!E || (S[0] & 131104 && c !== (c = T[18]('search_label', T[17], T[5])))) && p(t, 'aria-label', c),
      ...
      d(T) {
        T && C(e), n[31](null), n[32](null), d && d.d(), R && R.d(), (u = !1), V(m);
      }
    };
  }
  ...
  function Ai(n, e, t) {
    ...
    for (let g = 0; g < r.length; g++) s[r[g]] = { language: r[g], ...Un[g].strings };
...
`)
          ...
          await g.options(H);
          for (let O of d) {
            if (!O.bundlePath) throw new Error('mergeIndex requires a bundlePath parameter');
            let L = O.bundlePath;
      ...
      Jn = async () => {
        w && ((Jt = await w.filters()), (!ue || !Object.keys(ue).length) && t(16, (ue = Jt)));
      },
      Yn = g => {
        let H = {};
        return (
      ...
      Xn = async (g, H) => {
        ...
        let O = Yn(H),
          L = () => Zn(g, O);
        u > 0 && g ? (ce && clearTimeout(ce), (ce = setTimeout(L, u)), await Zt(), w.preload(g, { filters: O })) : L(),
          Qn();
      },
      Zt = async () => {
      ...
      Zn = async (g, H) => {
        t(14, (Kt = g || '')), typeof c == 'function' && (g = c(g)), t(12, (Z = !0)), t(13, ($e = !0)), await Zt();
        let O = ++Gt,
          L = await w.search(g, { filters: H });
        Gt === O &&
          (L.filters && Object.keys(L.filters)?.length && t(16, (ue = L.filters)),
          t(11, (P = L)),
          t(12, (Z = !1)),
          t(15, (et = i)));
      },
      ...
      $n = g => {
        g.key === 'Escape' && (t(6, (S = '')), B.blur()), g.key === 'Enter' && g.preventDefault();
      };
    function es() {
  ...
  var Vt;
  try {
    Vt = new URL(document.currentScript.src).pathname.match(/^(.*\/)(?:pagefind-)?ui.js.*$/)[1];
  } catch {
    Vt = '/pagefind/';
  }
  var xe = class {
