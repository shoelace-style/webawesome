...
<div class="wa:block-flow:3xl">
  <div class="wa:overflowing_hero">
    <div class="wa:grid wa:background:brand_spot_gradient" style="border-radius:var(--wa-panel-corners); padding:var(--wa-space-3xl); color:var(--wa-color-brand-text-on-spot);">
      <div>
  ...
  <div class="wa:block-flow:3xl" style="font-size:var(--wa-font-size-l); max-inline-size: 60ch; margin-inline: auto;">
    <div class="wa:block-flow:xl">
      ...
      <div class="wa:flex:fill" style="font-size:var(--wa-font-size-m);">
        ...
        <div class="wa:flex:cluster:gap-m">
    ...
    <div class="wa:block-flow:2xl" style="font-size:var(--wa-font-size-m);">
      ...
      <div class="wa:flex:fill">
        ...
        <wa-textarea rows="1" placeholder="Add a comment" style="flex: 1 1 auto;"></wa-textarea>
      </div>
      <div class="wa:flex:fill" style="align-items: start; flex-wrap: nowrap;">
        ...
        <div style="flex: 1 1 auto;">
          ...
          <div class="wa:flex:fill" style="align-items: start; flex-wrap: nowrap;">
            ...
            <div style="flex: 1 1 auto;">
              ...
              <div class="wa:flex:cluster:gap-xs">
                  <wa-icon-button name="thumbs-up" label="Like" style="color:var(--wa-color-neutral-text-on-surface)"></wa-icon-button>
                  <small style="margin-inline-start: -0.5rem;">(21)</small>
                <wa-button variant="text" size="small">Reply</wa-button>
              </div>
            </div>
          </div>
      ...
      <div class="wa:flex:fill" style="align-items: start; flex-wrap: nowrap;">
        ...
        <div style="flex: 1 1 auto;">
          ...
          <div class="wa:flex:cluster:gap-xs">
              <wa-icon-button name="thumbs-up" label="Like" style="color:var(--wa-color-neutral-text-on-surface)"></wa-icon-button>
              <small style="margin-inline-start: -0.5rem;">(1)</small>
            <wa-button variant="text" size="small">Reply</wa-button>
          </div>
        </div>
      </div>
  ...
  <div class="wa:grid:gap-m" style="background-color:var(--wa-color-brand-fill-subtle); padding:var(--wa-space-3xl); border-radius:var(--wa-panel-corners); box-shadow:var(--wa-shadow-level-1); margin-top:calc(var(--wa-space-3xl) * 2);">
