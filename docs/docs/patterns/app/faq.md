...
<div class="wa-flank wa-align-items-start wa-gap-2xl" style="--flank-size: 35ch">
  <div>
    ...
    <p>
      Can’t find an answer? Reach out to your local <a href="">Operator</a>, or contact <a href="">the Oracle</a>, and
      enjoy a cookie. &#127850;
    </p>
  </div>
  <dl class="wa-stack wa-gap-2xl">
    <div class="wa-stack wa-gap-xs">
      ...
      <dd>
        Ah, the question that keeps redpills up at night. Sure, we escaped the first Matrix, but who’s to say Zion isn’t
    ...
    <div class="wa-stack wa-gap-xs">
      ...
      <dd>
        ...
        intimidation. You ever try fighting someone in sunglasses and a tie? It’s terrifying.
      </dd>
    </div>
    <div class="wa-stack wa-gap-xs">
...
<div>
  ...
  <dl class="wa-grid wa-gap-m" style="--min-column-size: 30ch;">
    <div class="wa-stack wa-gap-xs">
      ...
      <dd>
        A course is updated once there is a fundamental shift in the language or library’s underlying API. You can check
    ...
    <div class="wa-stack wa-gap-xs">
      ...
      <dd>
        ...
        your Public Profile is included on each certificate if you’ve created one. Public Profiles showcase your
