...
<div class="wa-grid wa-gap-3xl">
  <div class="wa-stack">
    ...
    <wa-radio-group label="Shipping Method" name="shipping_method" value="standard" orientation="horizontal">
    ...
    <wa-divider></wa-divider>
    <h4>Payment</h4>
    <wa-radio-group label="Payment Method" name="payment_method" value="1" orientation="horizontal">
