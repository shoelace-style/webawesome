...
<div style="margin-block-end: 1rem;">
  <button class="wa-accent wa-outlined wa-neutral">Accent outlined</button>
...
<div style="margin-block-end: 1rem;">
  <button class="wa-accent wa-outlined wa-brand">Accent outlined</button>
...
<div style="margin-block-end: 1rem;">
  <button class="wa-accent wa-outlined wa-success">Accent outlined</button>
...
<div style="margin-block-end: 1rem;">
  <button class="wa-accent wa-outlined wa-warning">Accent outlined</button>
...
<div>
  <button class="wa-accent wa-outlined wa-danger">Accent outlined</button>
