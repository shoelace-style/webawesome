declare const LightPen_base: {
    ...
    define(name?: string | null | undefined, ctor?: CustomElementConstructor | null | undefined, options?: ElementDefinitionOptions | undefined): void;
} & typeof LitElement;
/**
 ...
 * @part sandbox-header - The wrapper around the header area
 */
export default class LightPen extends LightPen_base {
     ...
     * @type {ResizeObserver}
     */
    htmlResizeObserver: ResizeObserver;
    /**
     * @property
     * @type {ResizeObserver}
     */
    jsResizeObserver: ResizeObserver;
    /**
     * @property
     * @type {ResizeObserver}
     */
    cssResizeObserver: ResizeObserver;
    /**
     * @attribute
     * @reflect
     * @type {number}
     ...
     */
    get iframeElem(): HTMLIFrameElement | null | undefined;
    /**
     ...
     * @param {string} text
     */
    unescapeCharacters(text: string): string;
    /**
     * Highlighters strip newlines. But you can see new lines in <textarea>, this fixes that.
     * @param {string} text
     */
    injectNewLine(text: string): string;
    updateIframeContent(): void;
    inputHandler(): void;
    _iframeDebounce: NodeJS.Timeout | undefined;
    /**
     * @param {HTMLTextAreaElement} textarea
     */
    htmlTextAreaChanged(textarea: HTMLTextAreaElement): void;
    htmlTextArea: HTMLTextAreaElement | undefined;
    /**
     * @param {HTMLTextAreaElement} textarea
     */
    cssTextAreaChanged(textarea: HTMLTextAreaElement): void;
    cssTextArea: HTMLTextAreaElement | undefined;
    /**
     * @param {HTMLTextAreaElement} textarea
     */
    jsTextAreaChanged(textarea: HTMLTextAreaElement): void;
    jsTextArea: HTMLTextAreaElement | undefined;
    /**
     * @param {KeyboardEvent} event
     */
    handleResizerKeydown(event: KeyboardEvent): void;
    updateResizePosition(resizePosition?: number): void;
    /**
     ...
     * @param {Event} e
     */
    handleTemplate(e: Event): void;
    renderConsole(): import("lit").TemplateResult<1>;
    /**
     * @override
     */
     ...
     */
    renderDetails(language: SupportedLanguages): import("lit").TemplateResult<1>;
    /**
     * @internal
     * @param {Event} e
     */
...
export type SupportedLanguages = "html" | "css" | "js";
export type SafeTemplateElements = HTMLTextAreaElement | HTMLScriptElement | HTMLTemplateElement;
