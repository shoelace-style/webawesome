...
export type { WaDockLayoutChangeEvent } from './dock-layout-change.js';
export type { WaDockResizeEvent } from './dock-resize.js';
export type { WaDockTabCloseEvent } from './dock-tab-close.js';
export type { WaDockTabHideEvent } from './dock-tab-hide.js';
export type { WaDockTabMoveEvent } from './dock-tab-move.js';
export type { WaDockTabShowEvent } from './dock-tab-show.js';
