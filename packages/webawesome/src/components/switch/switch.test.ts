    ...
    describe(`with "${fixture.type}" rendering`, () => {
      ...
      describe('slots', () => {
        it('should render the default slot for label content', async () => {
          const el = await fixture<WaSwitch>(html`<wa-switch>Switch Label</wa-switch>`);
        ...
        it('should display hint text via the hint attribute', async () => {
          const el = await fixture<WaSwitch>(html`<wa-switch hint="Help text">Switch</wa-switch>`);
      ...
      describe('form integration', () => {
        ...
        it('should be valid when required and checked', async () => {
          const el = await fixture<WaSwitch>(html`<wa-switch required checked></wa-switch>`);
          expect(el.checkValidity()).to.be.true;
        });
