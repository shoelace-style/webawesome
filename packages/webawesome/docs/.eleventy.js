...
export default async function (eleventyConfig) {
  ...
  eleventyConfig.addGlobalData('themer', {
    ...
    elementPresets: [
      ...
      { name: 'Awesome', borderRadiusScale: 1.5, spaceScale: 1, borderWidthScale: 2 },
      { name: 'Shoelace', borderRadiusScale: 0.7, spaceScale: 1, borderWidthScale: 1 },
      { name: 'Active', borderRadiusScale: 1.75, spaceScale: 1, borderWidthScale: 1 },
      { name: 'Brutalist', borderRadiusScale: 0, spaceScale: 1.125, borderWidthScale: 2 },
      { name: 'Glossy', borderRadiusScale: 1.33, spaceScale: 1.125, borderWidthScale: 1 },
      { name: 'Matter', borderRadiusScale: 1.33, spaceScale: 1, borderWidthScale: 1 },
      { name: 'Mellow', borderRadiusScale: 1, spaceScale: 1.125, borderWidthScale: 1.5 },
      { name: 'Playful', borderRadiusScale: 2, spaceScale: 1, borderWidthScale: 3 },
      { name: 'Premium', borderRadiusScale: 0.5, spaceScale: 1, borderWidthScale: 1.5 },
      { name: 'Tailspin', borderRadiusScale: 1, spaceScale: 0.875, borderWidthScale: 1 },
    ],
    fontPresets: [
      {
        name: 'OS Default',
        fontFamilyBody: 'ui-sans-serif, system-ui, sans-serif',
        fontFamilyHeading: 'ui-sans-serif, system-ui, sans-serif',
        fontFamilyCode: 'ui-monospace, monospace',
        fontFamilyLongform: 'ui-serif, serif',
        fontWeightBody: 400,
        fontWeightHeading: 600,
        fontWeightCode: 400,
        fontWeightLongform: 400,
      },
      {
        name: 'Quicksand',
        fontFamilyBody: 'Quicksand, sans-serif',
      ...
      },
      {
        ...
        fontFamilyHeading: `'IBM Plex Sans Condensed', sans-serif`,
      ...
      {
        name: 'Figtree',
        fontFamilyBody: `'Figtree', sans-serif`,
        fontFamilyHeading: `'Figtree', sans-serif`,
        fontFamilyCode: 'ui-monospace, monospace',
        fontFamilyLongform: 'ui-serif, serif',
        fontWeightBody: 400,
      ...
      },
      {
        ...
        fontFamilyBody: `'Wix Madefor Text', sans-serif`,
        fontFamilyHeading: `'Wix Madefor Text', sans-serif`,
        fontFamilyCode: `'Roboto Mono', monospace`,
        fontFamilyLongform: `'Roboto Serif', serif`,
        fontWeightBody: 400,
        fontWeightHeading: 500,
        fontWeightCode: 400,
        fontWeightLongform: 400,
      ...
      {
        name: 'Mulish',
        fontFamilyBody: `'Mulish', sans-serif`,
        fontFamilyHeading: `'Lora', serif`,
        fontFamilyCode: 'ui-monospace, monospace',
        fontFamilyLongform: `'Lora', serif`,
        fontWeightBody: 400,
        fontWeightHeading: 700,
        fontWeightCode: 400,
        fontWeightLongform: 400,
      },
      {
        ...
        fontFamilyHeading: `'Fredoka', sans-serif`,
      ...
      },
      {
        ...
        fontFamilyCode: 'ui-monospace, monospace',
        fontFamilyLongform: `'Playfair', serif`,
        fontWeightBody: 400,
        fontWeightHeading: 500,
        fontWeightCode: 400,
        fontWeightLongform: 400,
