...
We’re fully aware that we may not get it right every time for every user, so we invite the community to participate in this ongoing effort by submitting [issues](https://github.com/shoelace-style/webawesome-alpha), pull requests, and [discussions](https://github.com/shoelace-style/webawesome-alpha/discussions). Many accessibility improvements have already been made thanks to contributors submitting code, feedback, and suggestions.
