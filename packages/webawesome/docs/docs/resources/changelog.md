...
- Fixed garbled component API tables in the `webawesome` Agent Skill by generating them from the Custom Elements Manifest instead of scraping the rendered HTML [issue:2475]
