...
- Fixed a bug in `<wa-dropdown-item>` where `:hover` styles failed to apply reliably due to the safe triangle's position interfering with the cursor [issue:2525]
