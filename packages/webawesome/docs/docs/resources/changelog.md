...
- Fixed a bug where required form controls without labels would still display the required asterisk (`*`) in an empty label [#1933](https://github.com/shoelace-style/webawesome/issues/1933)
  - `<wa-input>`
  - `<wa-textarea>`
  - `<wa-select>`
  - `<wa-checkbox>`
