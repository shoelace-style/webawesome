...
they do not directly apply styles, but define generic color tokens modeled after our [Variant Colors](/docs/tokens?active_tab=color) but _without_ the group identifier (`neutral`, `brand`, `success`, `warning`, `danger`), defaulting to `neutral`.
