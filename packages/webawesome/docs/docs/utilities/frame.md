...
Frames have a square border radius by default. You can add any of the following [`wa-border-radius-*`](/docs/tokens/borders) classes to an element with `wa-frame` to specify the border radius:
