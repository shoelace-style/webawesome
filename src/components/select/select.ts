          ...
          >
            ...
            >
              ...
              <input
                ...
                autocapitalize="off"
                readonly
                aria-invalid=${!this.validity.valid/** aria-invalid is required because readonly inputs are technically always valid so it never reads 'invalid data' for screen readers. */}
